    ...
    FirebaseDatabase.instance
      ...
      (value) async {
        if (value == null ||
          ...
          _warning =
              "This account doesn't exist. Please contact system admins.";
          ...
          bool admin = ll[ThingType.ADMIN] != null;
          bool radiologist = ll[ThingType.RADIOLOGIST] != null;

          if (admin || radiologist) {
            signIn(
              admin
                  ? ThingType.ADMIN
            ...
            handleError(
              "Unfortunately, you are not permitted to access this app. Please contact system admins incase of any issues.",
            );
          }
        }
      },
